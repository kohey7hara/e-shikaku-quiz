window.quizData = {
    ...
    cheatSheet: `
        ...
        <table class="tech-table" style="margin-top:10px;">
            ...
            <tr>
                ...
                <td>ブートストラップ標本で複数モデルを並列に独立学習し、多数決・平均を取る。<br><strong>バリアンス</strong>（過学習）を下げる。</td>
            </tr>
            <tr>
    ...
    questions: [
        ...
        },
        {
            ...
            options: ["復元抽出した複数のデータ集合でモデルを並列学習し、予測を平均・多数決する", "前のモデルの誤りを次のモデルが逐次修正する", "単一モデルの層を増やす", "正解ラベルを使わずに学習する"],
            answer: 0,
            explanation: "ブートストラップサンプリングで異なるデータ集合を作り、複数モデルの予測を統合することでバリアンス（過学習）を抑えます。"
        },
        {
            category: "ブースティング",
        ...
        },
        {
            ...
            options: ["カリキュラム学習 (Curriculum Learning)", "転移学習", "強化学習", "自己教師あり学習"],
            answer: 0,
        ...
        },
        {
            ...
            options: ["ラベルありデータで学習したモデルでラベルなしデータを予測し、確信度が高いものを「正解」とみなして学習データに追加する", "人間がラベルをつける", "ランダムにラベルをつける", "ラベルなしデータをすべて削除する"],
            answer: 0,
        ...
        },
        {
            ...
            answer: 0,
            explanation: "1回の抽出で選ばれない確率は4/5。独立に5回すべて選ばれないので $(4/5)^5$ です。復元抽出で元と同じ件数を選んでも、選ばれない標本が生じます。"
        }
    ]
};
